                        ...
                        {!isLoading && sensorHistory?.map((reading) => {
                            ...
                            return (
                                <TableRow key={reading.id}>
                                    ...
                                    <TableCell>
                                        {reading.heartRate != null ? `${reading.heartRate.toFixed(0)} bpm` : "—"}
                                    </TableCell>

                                    <TableCell>
                                        {reading.patientTemperature != null ? `${reading.patientTemperature.toFixed(1)} °C` : "—"}
                                    </TableCell>

                                    <TableCell>
                                        {reading.o2Saturation != null ? `${reading.o2Saturation.toFixed(1)} %` : "—"}
                                    </TableCell>
                                </TableRow>
                            );
                        })}
